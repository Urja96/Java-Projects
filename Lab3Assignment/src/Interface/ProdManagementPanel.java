...
public class ProdManagementPanel extends javax.swing.JPanel {
   ...
   /* This method is called from within the constructor to initialize the form.
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        CreateProductJPanel createproductpanel = new CreateProductJPanel(rightPanel, accDir);
        rightPanel.add("CreateProductJPanel", createproductpanel);
    ...
    private void btnManageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageActionPerformed
        // TODO add your handling code here:
        ManageProdPanel mngPanel = new  ManageProdPanel(product, rightPanel, accDir);
        rightPanel.add("manageProductPanel", mngPanel);
        CardLayout layout = (CardLayout)rightPanel.getLayout();
        layout.next(rightPanel);
